...
public:
  List342();
  List342(const List342 &sourceList);
  virtual ~List342();
  ...
  List342 operator+(const List342 &list2) const;
  List342& operator+=(const List342 &list2);
  bool operator==(const List342 &list2) const;
  bool operator!=(const List342 &list2) const;
  List342& operator=(const List342 &list2);

  template <class ItemType> 
  friend ostream& operator<<(ostream& outStream, const List342<ItemType> &list2);
